...
if (!$post_data) {
    ...
    $post_title = !empty($post_title_param) ? urldecode($post_title_param) : __('Blog', 'sbs-portal');
                ...
                <article class="blog-detail-article">
                    ...
                    <div class="blog-detail-content-text">
                        ...
                        <div class="content-section mb-4">
                            <h2 class="content-heading"><?php echo __('Course Information', 'sbs-portal'); ?></h2>
                        ...
                        <div class="content-section">
                            <h2 class="content-heading"><?php echo __('Lesson List', 'sbs-portal'); ?></h2>
                            <div class="content-body">
                                <?php if ($post_excerpt): ?>
                                    <p><?php echo esc_html($post_excerpt); ?></p>
                                <?php else: ?>
                                    <p><?php echo __('Lesson details are being prepared.', 'sbs-portal'); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="blog-posts-main-grid">
                        ...
                        ?>
                            ...
                            if (!empty($related_posts)) :
                                ...
                                <div class="no-related-posts">
                                    <p><?php echo __('No related posts.', 'sbs-portal'); ?></p>
                                </div>
                        <?php
                            endif;
                        endif;
                    ...
                    <div class="view-all-section">
                        <a class="sbs-btn-outline-sm text-decoration-none" href="<?php echo esc_url(get_post_type_archive_link('blog') ?: home_url('/blog/')); ?>">
                            <span><?php echo __('View All', 'sbs-portal'); ?></span>
